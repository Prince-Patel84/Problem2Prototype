...
class LLMService:
    """Manages ChatOllama connections, GPU offloading, fallbacks, and invocation helpers."""
    ...
    def invoke(self, system_prompt: str, user_content: str) -> str:
        """Executes a standard system + user prompt pair."""
    ...
    def refine(self, original_output: str, user_feedback: str, role_title: str = "Senior Software Engineering Specialist") -> str:
        """Refines existing output incorporating direct human feedback."""
